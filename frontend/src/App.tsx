          ...
          <div className="relative mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:py-28">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <a
                  href="#eventos"
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg- t4u-primary px-5 py-3 font-bold text-stone-50 transition hover:bg-t4u-secondary focus:outline-none focus:ring-2 focus:ring- t4u-primary focus:ring-offset-2 focus:ring-offset-stone-950"
                >
                  Explorar eventos
            ...
            <div className="rounded-3xl border border-t4u-secondary/20 bg-gradient-to-br from-t4u-secondary via-from-t4u-primary via-t4u-primary to-t4u-secondary to-from-t4u-primary via-t4u-primary to-t4u-secondary p-8 text-stone-950 shadow-2xl shadow-amber-950/20">
